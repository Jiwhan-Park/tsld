...
gm_a = np.array([1/2, 1/2, 1/2, 1/2, 1/2, 1/2, 1/2, 1/2, 1/2, 1/2])
r = 1
gamma = 1 / 4
...
np.savetxt('10D-asymmetric_gaussian_mixture-regret.csv', cumreg_ULA.T, delimiter=',')
np.savetxt('10D-asymmetric_gaussian_mixture-moderr.csv', model_error.T, delimiter=',')
np.savetxt('10D-asymmetric_gaussian_mixture-rejection.csv', rejection.T, delimiter=',')
np.savetxt('10D-asymmetric_gaussian_mixture-time.csv', time_simul.T, delimiter=',')
for simulation in range(simul):
    np.savetxt(f'10D-asymmetric_gaussian_mixture-traj{simulation + record}.csv', traj[simulation], delimiter=',')
...
plt.plot(x_vals, y, 'r-', label='Asymmetric GM 10D')
