...
def gaussian_mixture_grad_log(phi, z_batch, x_prime_batch, mean, grad_log_b, grad_log_phi, grad_sum, w, dot_batch, const_batch, r, n, m, lam):
...
def gaussian_mixture_hess_log(phi, z_batch, x_prime_batch, zzT_batch, mean, mmT_batch, hess_init, hess_sum_init, hess_log_phi, hess_sum, w, dot_batch, exp_batch, const_batch, kron_term, r, n, m, lam):
...
def newton_method(data, mean, r, n, m, lam, N, device):
    batch_size = len(data)
    dtype = data.dtype
    ...
    for _ in range(N):
        gaussian_mixture_hess_log(phi, z_batch, x_prime_batch, zzT_batch, mean_gpu, mmT_batch, hess_init, hess_sum_init, hess_log_phi, hess, w,
                                  dot_batch, exp_batch, const_batch, kron_term, r, n, m, lam)
        gaussian_mixture_grad_log(phi, z_batch, x_prime_batch, mean_gpu, grad_log_b, grad_log_phi, grad, w,
                                  dot_batch, const_batch, r, n, m, lam)
